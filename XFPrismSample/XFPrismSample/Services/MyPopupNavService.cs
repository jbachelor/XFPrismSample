...
#endif
    public class MyPopupNavService : MyNavService
    {
        protected IPopupNavigation _popupNavigation { get; }

        public MyPopupNavService(IPopupNavigation popupNavigation, IContainerExtension container,
        ...
        protected override async Task<INavigationResult> GoBackInternal(INavigationParameters parameters, bool? useModalNavigation, bool animated)
        {
            ...
            try
            {
                ...
                switch (MyPopupUtilities.TopPage(_popupNavigation, _applicationProvider))
                {
                    case PopupPage popupPage:
                        ...
                        var previousPage = MyPopupUtilities.GetOnNavigatedToTarget(_popupNavigation, _applicationProvider);
        ...
        protected override async Task DoPush(Page currentPage, Page page, bool? useModalNavigation, bool animated, bool insertBeforeLast = false, int navigationOffset = 0)
        {
            ...
            switch (page)
            {
                case PopupPage popup:
                    ...
                    {
                        throw new MyPopupNavigationException(MyPopupNavigationException.RootPageHasNotBeenSet, popup);
                    }
